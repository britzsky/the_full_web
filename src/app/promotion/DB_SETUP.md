...
- 게시글 목록: `GET /promotion/posts`
- 게시글 상세: `GET /promotion/posts/{id}`
- 인접글 조회: `GET /promotion/posts/{id}/adjacent`
- 게시글 등록: `POST /promotion/posts`
- 게시글 수정: `PATCH /promotion/posts/{id}`
- 게시글 삭제: `DELETE /promotion/posts/{id}` (소프트삭제)
