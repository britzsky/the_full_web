...
const menuLinks = [
  ...
  { label: "left", href: "/test3/left" },
  { label: "right", href: "/test3/right" },
];
...
// 우측 상세 페이지 콘텐츠 데이터
const detailData = {
  background: "/images/test3/main31.webp",
  title: "정성으로 완성되는 하루의 식사",
  subtitle: "DAILY MEAL CARE",
  body:
    "현장의 흐름을 이해하고, 시간과 동선을 고려한 맞춤 운영을 제공합니다. 한 끼의 만족이 하루의 컨디션을 바꾼다는 마음으로 준비합니다.",
};

const Page = () => {
  return (
    <>
      {/* right 페이지 전체 레이아웃 클래스 */}
